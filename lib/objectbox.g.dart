  ...
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ...
        ModelProperty(
            ...
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 1118764966067220),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 3003377829947421413),
            name: 'image',
            type: 9,
            flags: 0),
        ModelProperty(
...
class Groups_ {
  ...
  /// see [Groups.description]
  static final description =
      QueryStringProperty<Groups>(_entities[3].properties[2]);

  /// see [Groups.image]
  static final image = QueryStringProperty<Groups>(_entities[3].properties[3]);

  /// see [Groups.id]
  static final id = QueryIntegerProperty<Groups>(_entities[3].properties[4]);
}
